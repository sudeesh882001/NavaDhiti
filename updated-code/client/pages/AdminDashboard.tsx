...
import { sendBulkUserNotifications } from "@/lib/emailService";
import { 
  Users, 
  MessageSquare, 
  Flag, 
...
const approveQuestion = async (questionId: string) => {
    try {
        ...
        if (response.ok) {
            const data = await response.json(); // Backend might return info, or just a success message

            toast({
                title: "Question Approved",
                description: "The question has been approved and notifications have been initiated.", // Clarify this is initiated on backend
            });
        ...
        toast({
            title: "Error",
            description: "Failed to approve question (network or server issue).",
            variant: "destructive",
        });
    }
};
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card>
              ...
              <Button
  onClick={() => {
    const element = document.querySelector('[data-value="pending"]');
    if (element) {
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <Badge variant="default">{pendingQuestions.length}</Badge>
                </CardTitle>
